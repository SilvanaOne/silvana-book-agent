...
export function TopBar({ active = "dashboard", onChange, live }: Props) {
  ...
  useEffect(() => {
    const upd = () => { const d = new Date(); const pad = (n: number) => n.toString().padStart(2, "0"); setNow(`${pad(d.getHours())}:${pad(d.getMinutes())}:${pad(d.getSeconds())}`); };
  ...
  return (<>
    <div className="topbar">
      <div className="brand">
        ...
        <span className="brand-title">Compliance Screening</span>
