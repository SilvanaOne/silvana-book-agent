...
export function InfoGrid({ infinitegrid, walk }: Props) {
  ...
  const armed = infinitegrid !== null && c !== undefined;
  const driftHot = armed && infinitegrid!.lastDriftPct > (c!.driftThresholdPct);
  ...
  return (
    <div className="info-grid">
      ...
      <div className="info-card">
        ...
        {c ? (
          <>
            ...
            <div className="kv-row"><span className="k">step</span><span className="v accent">{c.stepPct}%</span></div>
      ...
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">drift vs center</span><span className={`v ${driftHot ? "accent" : ""}`}>{pct(infinitegrid?.lastDriftPct)}</span></div>
      ...
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">drift threshold</span><span className="v">{c ? `${c.driftThresholdPct}%` : "—"}</span></div>
