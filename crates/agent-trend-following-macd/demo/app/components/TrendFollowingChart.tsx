...
export function TrendFollowingChart({ ticks, trendfollowing }: Props) {
  if (ticks.length === 0 || !trendfollowing) {
    return <div style={{ height: H, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-faint)" }}>No data — start MACD to see mid, fast/slow EMAs and crossover signals.</div>;
  }
