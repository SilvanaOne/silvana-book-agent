...
export function TopBar({ active = "dashboard", onChange, live }: Props) {
  ...
  return (<>
    <div className="topbar">
      <div className="brand"><span className="brand-mark">E</span><span className="brand-title">Trade Explain</span><span className="brand-agent">Agent</span><span className="chip">CANTON</span></div>
      <nav className="nav">
    ...
    <div className="statusrow">
      ...
      <span className="status-role">auditor</span>
