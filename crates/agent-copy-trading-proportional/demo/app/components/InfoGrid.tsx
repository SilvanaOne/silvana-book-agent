  ...
  return (
    <div className="info-grid">
      ...
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">follower port</span><span className="v">{c?.followerPortfolio ?? "—"}</span></div>
        <div className="kv-row"><span className="k">leader port</span><span className="v">{c?.leaderPortfolio ?? "—"}</span></div>
        <div className="kv-row"><span className="k">raw scale</span><span className="v">{agent ? agent.rawScale.toFixed(4) : "—"}</span></div>
        <div className="kv-row"><span className="k">effective scale</span><span className="v accent">{agent ? agent.effectiveScale.toFixed(4) : "—"}</span></div>
        <div className="kv-row"><span className="k">max scale cap</span><span className="v">{c?.maxScale ?? "—"}</span></div>
