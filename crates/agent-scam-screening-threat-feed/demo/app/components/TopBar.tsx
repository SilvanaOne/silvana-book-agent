...
export function TopBar({ active = "dashboard", onChange, live }: Props) {
  ...
  return (<>
    <div className="topbar">
      <div className="brand"><span className="brand-mark">S</span><span className="brand-title">Scam Screening</span><span className="brand-agent">Agent</span><span className="chip">CANTON</span></div>
      <nav className="nav">
