  ...
  return (
    <div className="info-grid">
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">strategy mode</span><span className="v">mean-reversion</span></div>
      ...
      <div className="info-card">
        ...
        {c ? (
          <>
            ...
            <div className="kv-row"><span className="k">ema window</span><span className="v">{c.emaWindow}</span></div>
            <div className="kv-row"><span className="k">deviation</span><span className="v accent">±{c.deviationPct}%</span></div>
          ...
          <>
            ...
            <div className="kv-row"><span className="k">ema window</span><span className="v faint">—</span></div>
            <div className="kv-row"><span className="k">deviation</span><span className="v faint">—</span></div>
      ...
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">ema</span><span className="v accent">{fmt(mr?.ema ?? null)}</span></div>
        <div className="kv-row"><span className="k">diff vs ema</span><span className={`v ${armed && mr && Math.abs(mr.lastDiffPct) > c!.deviationPct ? "accent" : ""}`}>{pct(mr?.lastDiffPct)}</span></div>
        <div className="kv-row"><span className="k">state</span><span className="v">{stateLabel}</span></div>
      </div>

      <div className="info-card">
        <div className="info-card-head"><div className="info-card-title">EMA</div></div>
        <div className="kv-row"><span className="k">alpha (2/N+1)</span><span className="v">{mr ? mr.alpha.toFixed(4) : "—"}</span></div>
        <div className="kv-row"><span className="k">samples</span><span className="v">{mr?.samples ?? 0}{c ? ` / ${c.warmupSamples} warmup` : ""}</span></div>
        <div className="kv-row"><span className="k">upper band</span><span className="v">{mr?.ema && c ? fmt(mr.ema * (1 + c.deviationPct / 100)) : "—"}</span></div>
        <div className="kv-row"><span className="k">lower band</span><span className="v">{mr?.ema && c ? fmt(mr.ema * (1 - c.deviationPct / 100)) : "—"}</span></div>
      </div>
