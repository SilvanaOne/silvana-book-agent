// Port of agent-target-allocation-absolute-value placement logic to TypeScript. Mirrors
// crates/agent-target-allocation-absolute-value/src/main.rs (fn alloc_loop).
//
