  ...
  return (
    <div className="info-grid">
      ...
      <div className="info-card">
        ...
        <div className="kv-row"><span className="k">triggered</span><span className="v">{position?.triggeredReason ?? "—"}</span></div>
      </div>

      <div className="info-card">
        <div className="info-card-head"><div className="info-card-title">BRACKET LEGS</div></div>
        <div className="kv-row"><span className="k">TP price</span><span className="v accent">{fmt(cfg?.tp)}</span></div>
        <div className="kv-row"><span className="k">TP status</span><span className="v">{position?.tpLeg.status ?? "—"}</span></div>
        <div className="kv-row"><span className="k">SL price</span><span className="v">{fmt(cfg?.sl)}</span></div>
        <div className="kv-row"><span className="k">SL status</span><span className="v">{position?.slLeg.status ?? "—"}</span></div>
      </div>
