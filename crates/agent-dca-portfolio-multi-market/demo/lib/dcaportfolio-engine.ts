// Port of agent-dca-portfolio-multi-market placement logic to TypeScript. Mirrors
// crates/agent-dca-portfolio-multi-market/src/main.rs (fn dca_loop, fanned out across
