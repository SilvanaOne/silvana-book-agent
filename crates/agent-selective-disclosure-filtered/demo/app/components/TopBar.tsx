...
export function TopBar({ active = "dashboard", onChange, live }: Props) {
  ...
  return (<>
    <div className="topbar">
      <div className="brand"><span className="brand-mark">D</span><span className="brand-title">Selective Disclosure</span><span className="brand-agent">Agent</span><span className="chip">CANTON</span></div>
      <nav className="nav">
