// Port of agent-volatility-screening-rolling-stddev publisher logic to TypeScript. Mirrors
// crates/agent-volatility-screening-rolling-stddev/src/main.rs (fn run).
//
// Rule:
