...
export function TopBar({ active = "dashboard", onChange, live }: Props) {
  ...
  return (<>
    <div className="topbar">
      <div className="brand"><span className="brand-mark">N</span><span className="brand-title">News Sentiment</span><span className="brand-agent">Agent</span><span className="chip">CANTON</span></div>
      <nav className="nav">
