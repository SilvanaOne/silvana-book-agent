// Port of agent-failure-recovery-settlement-watchdog sweep logic to TypeScript. Mirrors
// crates/agent-failure-recovery-settlement-watchdog/src/main.rs (fn sweep).
//
// Model:
