// Port of agent-liquidity-seeking-slippage-bounded execution logic to TypeScript. Mirrors the
// core rule in crates/agent-liquidity-seeking-slippage-bounded/src/main.rs (fn seek_loop /
// max_safe_qty):
//
//   Each cycle:
